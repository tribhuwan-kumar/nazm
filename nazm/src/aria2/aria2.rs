...
impl Aria2Worker {
    async fn run(
		...
		// wait a little till aria2 daemon starts
        ...
        loop {
            ...
            info!("Connecting NAZM to Aria2 at: {:?}", worker.url);
            ...
            match connect_async(parsed_url.unwrap().as_str()).await {
                ...
                Err(e) => {
                    ...
                    error!("Failed to connect to Aria2: {}. Retrying in 2s...", e);
